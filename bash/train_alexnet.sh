...
mprof run -o "logs/mprofile_<YYYYMMDDhhmmss>.dat" train_alexnet.py -i tf_data/alexnet.tfrecords -o models/alexnet2 -l tensorboard/alexnet2_lr_0.0005 -b 100 -e 50