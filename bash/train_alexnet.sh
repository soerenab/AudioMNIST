...
mprof run -o "logs/mprofile_<YYYYMMDDhhmmss>.dat" train_audionet.py -i tf_data/alexnet.tfrecords -o models/alexnet2 -l tensorboard/audionet2_lr_0.0005 -b 100 -e 50