...
def build_model():
    ...
    model.add(layers.Conv1D(100, 3, input_shape= (8000, 1), padding='same', activation='relu', name='conv1'))
    model.add(layers.MaxPooling1D(pool_size=2, strides=2, name='pool1'))

    model.add(layers.Conv1D(64, 3, padding='same', activation='relu', name='conv2'))
    model.add(layers.MaxPooling1D(pool_size=2, strides=2, name='pool2'))

    model.add(layers.Conv1D(128, 3, padding='same', activation='relu', name='conv3'))
    model.add(layers.MaxPooling1D(pool_size=2, strides=2, name='pool3'))

    model.add(layers.Conv1D(128, 3, padding='same', activation='relu', name='conv4'))
    model.add(layers.MaxPooling1D(pool_size=2, strides=2, name='pool4'))

    model.add(layers.Conv1D(128, 3, padding='same', activation='relu', name='conv5'))
    model.add(layers.MaxPooling1D(pool_size=2, strides=2, name='pool5'))

    model.add(layers.Conv1D(128, 3, padding='same', activation='relu', name='conv6'))
